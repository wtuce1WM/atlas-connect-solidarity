  ...
  <Html lang="fr" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={small}>
          Ce lien est valable une seule fois et expire après 24 heures. Passé ce délai, demandez-en un nouveau depuis la page de connexion partenaire. Une fois votre mot de
