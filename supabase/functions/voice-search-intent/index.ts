...
- "taxi", "taxi aéroport", "transfert aéroport", "navette aéroport", "je cherche un taxi", "taxi pour l'aéroport" → "chauffeur privé" + ville si mentionnée (catégorie "Transport")
