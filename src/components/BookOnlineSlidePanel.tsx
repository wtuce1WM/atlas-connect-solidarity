          ...
          <div className="flex-1 flex flex-col items-center overflow-hidden min-h-0 gap-3 pointer-events-auto">
            ...
            <div className="w-[95%] md:w-[90%] shrink-0 rounded-2xl bg-black/40 backdrop-blur-sm px-4 md:px-6 text-white overflow-hidden relative h-[5.5rem]">
              ...
              {hookText && (
                ...
                >
                  <p className="text-base md:text-lg text-white/90 italic text-center leading-relaxed pr-20 md:pr-28 lg:pr-20">{hookText}</p>
                </div>
              )}
            ...
            <div className="w-[95%] md:w-[90%] shrink-0">
              <div ref={carouselRef} className="flex gap-3 overflow-x-auto scrollbar-hide snap-x snap-mandatory pb-1">
                {/* Card 1: Texte */}
                {woDescription && (
                  <div className="snap-start shrink-0 w-[85%] md:w-[45%] rounded-2xl bg-black/40 backdrop-blur-sm p-4 text-white max-h-[24em] overflow-y-auto">
                ...
                {(business.phone || business.whatsapp || business.email || business.website || business.address) && (
                  <div className="snap-start shrink-0 w-[85%] md:w-[45%] h-[24em]" style={{ perspective: '1000px' }}>
                    <div
