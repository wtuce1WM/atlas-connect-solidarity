          ...
          <div key={businessId} className="w-full shrink-0 rounded-2xl bg-black/40 backdrop-blur-sm px-4 md:px-6 text-white overflow-hidden relative h-[5.5rem] pointer-events-auto mt-3 md:mt-0 animate-slide-in-right">
            ...
            >
              ...
              <div className="min-w-0 flex-1 text-center md:text-left">
                <h2 className="text-xl font-extrabold truncate drop-shadow-lg uppercase" style={{ fontFamily: "'Josefin Sans', sans-serif", letterSpacing: '0.12em' }}>{business.name}</h2> style={{ fontFamily: "'Josefin Sans', sans-serif", letterSpacing: '0.12em' }}>{business.name}</h2> style={{ fontFamily: "'Josefin Sans', sans-serif", letterSpacing: '0.12em' }}>{business.name}</h2>
