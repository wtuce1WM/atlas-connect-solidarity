...
import { MobileFlagsOpenBadgeAlternator } from "@/components/MobileFlagsOpenBadgeAlternator";
        ...
        <div key={businessId + '-topbar'} className="relative z-40 overflow-visible flex flex-col items-center pt-3 pb-1 pointer-events-auto">
          {cardsHidden ? (
            ...
            <CardsToggleButton
              ...
              leftSlot={languages.length > 0 || openBadgeInfo?.text ? (
                <MobileFlagsOpenBadgeAlternator
                  languages={languages}
                  openBadgeInfo={openBadgeInfo}
                  getLangAlt={getLangAlt}
