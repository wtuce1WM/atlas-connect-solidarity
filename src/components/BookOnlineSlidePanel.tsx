            ...
            {avgOn20 != null && totalReviewCount > 0 && (
              <>
                {(() => {
                  ...
                  return (
                    <p
                      className="text-base md:text-lg text-white/90 italic text-center max-w-[95%] md:max-w-xl leading-relaxed line-clamp-4 md:line-clamp-6 pl-8 pr-0 md:px-0 cursor-pointer"
