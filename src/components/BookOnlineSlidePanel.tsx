              ...
              <div className="w-full overflow-x-auto pb-1 scrollbar-hide snap-x snap-mandatory mb-2">
                ...
                {destinations.slice(0, 3).map((dest, index) => {
                  ...
                  return (
                    <div
                      key={dest.id}
                      className={`${isLast ? "snap-end" : "snap-start"} shrink-0 w-80 h-[18em] md:h-[24em] rounded-2xl overflow-hidden bg-black/40 backdrop-blur-sm border border-white/10 animate-slide-in-left opacity-0 cursor-pointer hover:border-white/30 transition-colors flex flex-col`}
