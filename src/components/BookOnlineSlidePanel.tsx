        ...
        <div key={businessId + '-topbar'} className="relative z-40 overflow-visible flex flex-col items-center pt-3 pb-1 pointer-events-auto">
          {cardsHidden ? (
            ...
            <CardsToggleButton
              ...
              middleSlot={hookText ? (
                <p
                  className="md:hidden text-base text-white/90 font-bold text-center max-w-[95%] md:max-w-[85%] leading-relaxed pointer-events-none px-2"
                  style={{
                    fontFamily: "'Josefin Sans', sans-serif",
                    filter: "drop-shadow(0 0 2px hsla(0,0%,0%,1)) drop-shadow(0 0 6px hsla(0,0%,0%,0.9)) drop-shadow(0 2px 12px hsla(0,0%,0%,0.7)) drop-shadow(0 4px 24px hsla(0,0%,0%,0.4))",
                  }}
            ...
            {avgOn20 != null && totalReviewCount > 0 && (
              <>
                {(() => {
                  ...
                  return (
                    <p
                      className="text-base md:text-lg text-white/90 italic text-center max-w-[95%] md:max-w-xl leading-relaxed line-clamp-6 md:line-clamp-4 cursor-pointer"
                      style={{
                        fontFamily: "'Josefin Sans', sans-serif",
                        filter: "drop-shadow(0 0 2px hsla(0,0%,0%,1)) drop-shadow(0 0 6px hsla(0,0%,0%,0.9)) drop-shadow(0 2px 12px hsla(0,0%,0%,0.7)) drop-shadow(0 4px 24px hsla(0,0%,0%,0.4))",
                      }}
