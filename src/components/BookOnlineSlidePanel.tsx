          ...
          <div className="flex gap-1 w-max">
            ...
            {bottomTabs.map((tab) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-full transition-colors border border-transparent ${tab.id === "videos" ? "max-w-[160px] truncate md:max-w-none md:overflow-visible md:text-clip whitespace-nowrap" : "whitespace-nowrap"} ${
