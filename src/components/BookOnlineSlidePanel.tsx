        ...
        >
          ...
          <div className="flex-1 flex flex-col items-center overflow-x-visible overflow-y-hidden min-h-0 gap-3 pointer-events-auto mt-3 md:mt-0">
            ...
            {/* Block 2: Horizontal card carousel */}
              <div ref={carouselRef} className="w-full shrink-0 flex gap-3 overflow-x-auto scrollbar-hide snap-x snap-mandatory pb-1 pr-4 md:pr-6" style={{ marginRight: '-1rem', paddingRight: '0px' }}>
                {/* Card 1: Texte */}
                {woDescription && (
