    ...
    <div className="h-full overflow-visible overscroll-none bg-black relative">
              ...
              <div className="snap-start shrink-0 w-[20rem] md:w-[30rem] h-[15em] md:h-[20em] mb-4 relative animate-slide-in-left opacity-0"
                ...
                >
                  <div className="h-full rounded-2xl bg-black/40 backdrop-blur-sm p-4 text-white overflow-y-auto border border-white/10">
                    <div
                      className="prose prose-invert prose-sm max-w-none break-words text-sm leading-relaxed font-['Roboto',sans-serif] prose-josefin-headings prose-h2:text-xl prose-h3:text-lg card1-headings [&_*]:!text-white [&_a]:!text-white/90 [&_a:hover]:!text-white [&_ul]:list-disc [&_li::marker]:text-gold [&_h2]:!font-bold [&_h2]:!uppercase [&_h3]:!font-bold"
      ...
      {showDescriptionOverlay && woDescription && (
        <div className="absolute inset-0 top-0 lg:-top-[3.3rem] z-[80] animate-zoom-out-center overflow-hidden flex flex-col">
          ...
          {/* Sticky image thumbnails strip */}
          {images.length > 0 && (
            <div className="relative z-20 shrink-0 flex items-center gap-1.5 px-2 py-2 bg-black/40 backdrop-blur-md border-t border-white/10">
