  ...
  return (
    <div className="h-full overflow-visible overscroll-none bg-black relative">
      ...
      {showDescriptionOverlay && woDescription && (
        <div className="absolute inset-0 -top-[3.3rem] z-[80] animate-zoom-out-center overflow-hidden">
          {/* Background image */}
          {images[0] && (
            <div
