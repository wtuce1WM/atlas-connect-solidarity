  ...
  return (
    <div className="h-full overflow-visible overscroll-none bg-black relative">
      ...
      >
        ...
        <div className={`shrink-0 flex justify-start md:justify-center gap-1 pt-2 pb-1 overflow-x-auto scrollbar-hide pointer-events-auto -ml-2 pr-1 md:-ml-2 md:pr-1 ${isLoading ? "invisible" : ""}`}>
          {bottomTabs.map((tab) => (
            <button
              key={tab.id}
