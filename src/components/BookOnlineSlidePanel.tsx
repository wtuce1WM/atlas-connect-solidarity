        ...
        >
          ...
          <div className="flex-1 flex flex-col items-center overflow-x-visible overflow-y-hidden min-h-0 gap-3 pointer-events-auto mt-3 md:mt-0">
            ...
            <div className="w-full shrink-0 self-start">
              <div ref={carouselRef} className="w-[calc(100%+1rem)] -mr-4 md:w-[calc(100%+1.5rem)] md:-mr-6 flex gap-3 overflow-x-auto pl-4 pb-1 scrollbar-hide snap-x snap-mandatory [&>*:last-child]:mr-0" style={{ scrollPaddingInlineEnd: 0 }}>
                {/* Card 1: Texte */}
                {woDescription && (
