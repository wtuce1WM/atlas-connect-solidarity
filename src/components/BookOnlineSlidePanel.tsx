        ...
        >
          ...
          <div className="flex-1 flex flex-col items-center overflow-x-visible overflow-y-hidden min-h-0 gap-3 pointer-events-auto mt-3 md:mt-0">
            ...
            {/* Block 2: Horizontal card carousel */}
              <div ref={carouselRef} className="w-[calc(100%+1rem)] -mr-4 md:w-[calc(100%+1.5rem)] md:-mr-6 shrink-0 self-start flex gap-3 overflow-x-auto pl-4 md:pl-6 pr-0 pb-1 scrollbar-hide snap-x snap-mandatory">
                {/* Card 1: Texte */}
                {woDescription && (
                  <div className="snap-start last:snap-end last:mr-[-1rem] md:last:mr-[-1.5rem] shrink-0 w-[85%] md:w-[45%] rounded-2xl bg-black/40 backdrop-blur-sm p-4 text-white max-h-[18em] md:max-h-[24em] overflow-y-auto">
                ...
                {(business.phone || business.whatsapp || business.email || business.website || business.address) && (
                  <div className="snap-start last:snap-end last:mr-[-1rem] md:last:mr-[-1.5rem] shrink-0 w-[85%] md:w-[45%] h-[18em] md:h-[24em]" style={{ perspective: '1000px' }}>
                    <div
