            ...
            <div className="flex w-max gap-2">
              ...
              {woDescription && (
                <div className="snap-start shrink-0 w-[20rem] md:w-[30rem] h-[18em] md:h-[24em] mb-4 rounded-2xl bg-black/40 backdrop-blur-sm p-4 text-white overflow-y-auto animate-slide-in-left opacity-0 border border-white/10"
                  ...
                  >
                    <div
                      className="prose prose-invert prose-sm max-w-none break-words text-sm leading-relaxed font-['Roboto',sans-serif] [&_*]:!text-white [&_a]:!text-white/90 [&_a:hover]:!text-white [&_ul]:list-disc [&_li::marker]:text-[#C04F17] [&_h1]:!font-normal [&_h2]:!font-normal [&_h3]:!font-normal [&_h4]:!font-normal [&_h1]:!font-['Josefin_Sans',sans-serif] [&_h2]:!font-['Josefin_Sans',sans-serif] [&_h3]:!font-['Josefin_Sans',sans-serif] [&_h4]:!font-['Josefin_Sans',sans-serif] [&_h5]:!font-['Josefin_Sans',sans-serif] [&_h6]:!font-['Josefin_Sans',sans-serif] [&_h1]:!normal-case [&_h2]:!uppercase [&_h3]:!normal-case [&_h4]:!normal-case [&_h5]:!normal-case [&_h6]:!normal-case [&_h1]:!tracking-[0.02em] [&_h2]:!tracking-[0.12em] [&_h3]:!tracking-[0.02em]"
