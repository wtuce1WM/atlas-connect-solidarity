  ...
  return (
    <div className="h-full overflow-visible overscroll-none bg-black relative">
      ...
      >
        ...
        {cardsHidden && (
          <div className={`${effectiveMedia?.kind === "matterport" ? '' : 'flex-1'} w-full flex flex-col justify-center gap-3 px-0 md:px-8 overflow-y-auto ${effectiveMedia?.kind === "matterport" ? "pointer-events-none" : "pointer-events-auto"}`}>
            {hotelSearchLoading && (
