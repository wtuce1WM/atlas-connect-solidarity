            ...
            <div className="flex w-max gap-2">
              ...
              {woDescription && (
                <div className="snap-start shrink-0 w-[40rem] h-[18em] md:h-[24em] mb-4 rounded-2xl bg-black/40 backdrop-blur-sm p-4 text-white overflow-y-auto animate-slide-in-left opacity-0 border border-white/10"
                  ...
                  >
                    <div
                      className="prose prose-invert prose-sm max-w-none break-words text-sm leading-relaxed pb-6 [&_*]:!text-white [&_a]:!text-white/90 [&_a:hover]:!text-white [&_ul]:list-disc [&_li::marker]:text-[#C04F17]"
