  ...
  return (
    <div className="h-full overflow-visible overscroll-none bg-black relative">
      ...
      >
        ...
        {/* Tabs bar */}
        <div className="shrink-0 flex justify-start md:justify-center gap-1 px-1 pt-2 pb-1 overflow-x-auto scrollbar-hide pointer-events-auto">
          {bottomTabs.map((tab) => (
            <button
              key={tab.id}
              onClick={() => handleBottomTabChange(tab.id)}
              className={`px-3 py-1.5 rounded-full whitespace-nowrap truncate max-w-[10rem] md:max-w-none transition-colors border border-transparent ${
