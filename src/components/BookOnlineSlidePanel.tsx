  ...
  return (
    <div className="h-full overflow-visible overscroll-none bg-black relative">
      ...
      >
        ...
        >
        {/* Info Carousel */}
        <div className="shrink-0 w-[calc(100%_+_2.5rem)] -ml-4 -mr-6 md:w-[calc(100%_+_3rem)] md:-ml-6 md:-mr-6 overflow-hidden pr-0 pb-1 mt-3 pointer-events-auto">
          <div className="flex w-max gap-2 items-start overflow-x-auto scrollbar-hide snap-x snap-mandatory animate-slide-in-left">
