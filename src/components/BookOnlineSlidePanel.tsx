  ...
  return (
    <div className="h-full overflow-visible overscroll-none bg-black relative">
      ...
      >
        ...
        <div className={`shrink-0 flex justify-start md:justify-center gap-1 pl-0 pr-1 pt-2 pb-1 overflow-x-auto scrollbar-hide pointer-events-auto ${isLoading ? "invisible" : ""}`}>
          {bottomTabs.map((tab) => (
            <button
              key={tab.id}
            ...
            <div className="shrink-0 flex justify-center pointer-events-auto pb-4">
              ...
              >
                <span className="text-xs font-medium text-white truncate max-w-[180px]" style={{ fontFamily: "'Josefin Sans', sans-serif" }}>
                  {currentVideoDoc.owner_name} <span className="text-sm">©</span>
                </span>
