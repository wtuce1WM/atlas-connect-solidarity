        ...
        >
          ...
          <div className="flex-1 flex flex-col items-center overflow-x-visible overflow-y-hidden min-h-0 gap-3 pointer-events-auto mt-3 md:mt-0">
            ...
            {/* Block 2: Horizontal card carousel */}
              <div ref={carouselRef} className="w-[calc(100%+1rem)] -mr-4 md:w-[calc(100%+1.5rem)] md:-mr-6 shrink-0 flex gap-3 overflow-x-auto scrollbar-hide snap-x snap-mandatory pb-1 pr-0">
                {/* Card 1: Texte */}
                {woDescription && (
