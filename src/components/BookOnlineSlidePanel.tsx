    ...
    <div className="h-full overflow-hidden overscroll-none bg-black">
      ...
      <div className="relative w-full h-full">
        ...
        >
          ...
          <div className="shrink-0 w-[calc(100%_+_2rem)] -ml-4 -mr-4 md:w-[calc(100%_+_3rem)] md:-ml-6 md:-mr-6 overflow-x-auto pr-0 pb-1 scrollbar-hide snap-x snap-mandatory mt-3 pointer-events-auto">
            <div className="flex w-max gap-2 pl-8 md:pl-10">
              {/* Card 1: Texte Web only */}
              {woDescription && (
                <div className="snap-start shrink-0 <div className="snap-start shrink-0 w-[30rem] h-[18em] md:h-[24em] mb-4 rounded-2xl bg-black/40 backdrop-blur-sm p-4 text-white overflow-y-auto animate-slide-in-left opacity-0 border border-white/10" h-[18em] md:h-[24em] mb-4 rounded-2xl bg-black/40 backdrop-blur-sm p-4 text-white overflow-y-auto animate-slide-in-left opacity-0 border border-white/10"
              ...
              <div className="w-[calc(100%_+_1rem)] -mr-4 md:w-[calc(100%_+_1.5rem)] md:-mr-6 flex gap-2 overflow-x-auto pr-0 pb-1 scrollbar-hide">
                {destinations.map((dest, index) => {
                  ...
                  return (
                    ...
                    >
                      {destImg ? (
                        <img src={destImg} alt={destName(dest)} className="w-full h-[15rem] object-cover" />
                      ) : (
                        <div className="w-full h-[15rem] bg-white/10 flex items-center justify-center">
