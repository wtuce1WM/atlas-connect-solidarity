  ...
  return (
    <div className="h-full overflow-visible overscroll-none bg-black relative">
      ...
      {showExtLinksOverlay && externalLinks.length > 0 && (
        <div className="absolute inset-0 -top-[3.3rem] z-[85] flex items-center justify-center bg-black/70 backdrop-blur-sm" style={{ animation: "panelFadeIn 0.3s ease-out both" }}>
          <button
