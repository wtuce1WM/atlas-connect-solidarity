...
const Header = ({ variant = "default" }: HeaderProps) => {
  ...
  const navLinks = (
    <>
      ...
      <Link to="/devenir-affilie" className="rounded-lg bg-gold px-4 py-2 text-sm font-semibold text-gold-foreground transition-colors hover:bg-gold/90 text-center" onClick={() => setMobileOpen(false)}>
        {t("nav.joinNow")}
      </Link>
    </>
  );
  ...
  const footerContent = (
    <div className="mt-8 border-t border-border pt-6 px-2">
      {/* Brand description */}
