      ...
      <div className="relative w-full h-full">
        ...
        <div className={`relative z-10 flex flex-col h-[calc(100%-3rem)] md:h-full p-6 ${currentMedia?.kind === "video" ? "pointer-events-none" : ""}`}>
          ...
          <div className="flex-1 flex items-start md:items-center justify-center overflow-hidden min-h-0">
            <div className="w-[95%] md:w-[90%] lg:w-[70%] max-h-full md:max-h-none overflow-hidden rounded-2xl bg-black/40 backdrop-blur-sm p-4 md:p-6 space-y-5 text-white pointer-events-auto">
              {/* Logo + name */}
