...
const EMOJI_KEYWORDS: Record<string, string[]> = {
  ...
  "⚽":["soccer","football","foot"],"🏀":["basketball","basket"],"🎾":["tennis"],"🏐":["volleyball","volley"],"⛳":["golf"],"🏹":["archery","tir à l'arc"],"🎣":["fishing","pêche"],"🥊":["boxing","boxe"],"🥋":["martial arts","arts martiaux","karate","judo"],"🎿":["ski"],"🏂":["snowboard"],"🏊":["swimming","natation","nager"],"🚴":["cycling","vélo","cyclisme"],"🧗":["climbing","escalade"],"🏄":["surfing","surf"],"🧘":["yoga","méditation"],"🏆":["trophy","trophée"],"🥇":["gold medal","médaille or"],"🥈":["silver medal","médaille argent"],"🥉":["bronze medal","médaille bronze"],
