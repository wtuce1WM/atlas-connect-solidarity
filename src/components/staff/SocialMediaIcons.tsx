...
export const TripAdvisorIcon = ({ className }: IconProps) => (
  <svg className={cn("h-5 w-5", className)} viewBox="0 0 24 24" fill="currentColor">
...
export const BookingIcon = ({ className }: IconProps) => (
  <svg className={cn("h-5 w-5", className)} viewBox="0 0 24 24" fill="currentColor">
...
export const GoogleMapsIcon = ({ className }: IconProps) => (
  <svg className={cn("h-5 w-5", className)} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 0C7.802 0 4.4 3.402 4.4 7.6c0 5.7 7.6 16.4 7.6 16.4s7.6-10.7 7.6-16.4C19.6 3.402 16.198 0 12 0zm0 10.4c-1.543 0-2.8-1.257-2.8-2.8S10.457 4.8 12 4.8s2.8 1.257 2.8 2.8-1.257 2.8-2.8 2.8z"/>
  </svg>
);

export const AirbnbIcon = ({ className }: IconProps) => (
  <svg className={cn("h-5 w-5", className)} viewBox="0 0 24 24" fill="currentColor">
...
export const SkypeIcon = ({ className }: IconProps) => (
  <svg className={cn("h-5 w-5", className)} viewBox="0 0 24 24" fill="currentColor">
...
export const VimeoIcon = ({ className }: IconProps) => (
  <svg className={cn("h-5 w-5", className)} viewBox="0 0 24 24" fill="currentColor">
