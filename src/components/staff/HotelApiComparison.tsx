...
const HotelApiComparison = () => {
  ...
  const AUTOMATCH_BLACKLIST = new Set(["la villa's", "l'hôtel marrakech", "cruiser mogador essaouira", "hotel vents des iles", "moro boutique hotel", "mont gueliz", "jack's apartments"]);
