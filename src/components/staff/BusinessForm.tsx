  ...
  return (
    <div className="bg-background rounded-lg border">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div id="section-contact" className="p-4 border rounded-lg bg-orange-50 space-y-4" style={{ scrollMarginTop: '90px' }}>
        ...
        <div id="section-description" className="space-y-3" style={{ scrollMarginTop: '90px' }}>
          <Input
            id="hook_fr"
        ...
        <div id="section-menu" className="space-y-2" style={{ scrollMarginTop: '90px' }}>
          {formData.menu_url ? (
        ...
        {/* Video */}
        <div id="section-images" className="space-y-4 p-4 bg-orange-50 border border-orange-200 rounded-lg" style={{ scrollMarginTop: '90px' }}>
        ...
        {/* Social Media */}
        <div id="section-social" className="space-y-4 p-4 bg-orange-50 border border-orange-200 rounded-lg" style={{ scrollMarginTop: '90px' }}>
        ...
        {/* Avis clients */}
        <div id="section-avis" className="space-y-4 p-4 bg-violet-50 border border-violet-200 rounded-lg" style={{ scrollMarginTop: '90px' }}>
          <div className="flex items-center justify-between">
            <Label
        ...
        {/* Taxonomie */}
        <div id="section-taxonomie" className="space-y-6 p-4 bg-orange-50 border border-orange-200 rounded-lg" style={{ scrollMarginTop: '90px' }}>
        ...
        {/* Opening Hours */}
        <div id="section-horaires" className="space-y-4 p-4 bg-blue-50 border border-blue-200 rounded-lg" style={{ scrollMarginTop: '90px' }}>
        ...
        <div id="section-notes" className="space-y-2 p-4 border rounded-lg bg-amber-50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-800" style={{ scrollMarginTop: '90px' }}>
          <div className="flex items-center justify-between">
