  ...
  return (
    ...
    >
      ...
      */}
      ...
      <div className={`${scrollY > 0 ? "fixed top-0 left-0 right-0 z-[90]" : "absolute inset-0 z-[80]"} flex items-start justify-center pt-24 pointer-events-none`}>
      ...
      <div className="relative z-10 flex flex-col items-center px-4 pt-24 pb-16 gap-8">
        ...
        {/* Spacer for logo */}
        <div className="w-56 h-56 -mb-[20px] md:mb-0 md:w-96 md:h-96" />
