    ...
    <OverlayShell zClass="z-[80]" animClass={slideAnim} bg="bg-black" className="flex flex-col" coverToolbar={false}>
      ...
      <div className="relative w-full h-full">
        ...
        >
          ...
          <div className={`${cardsHidden && showSearchBar ? 'absolute bottom-[88px] left-0 right-0 z-[74] pb-[14px] md:pb-[10px]' : 'shrink-0 py-2 lg:pb-2'} flex flex-col items-center gap-2 pointer-events-auto`}>
