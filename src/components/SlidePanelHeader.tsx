...
const SlidePanelHeader = ({
  ...
  const baseClass = alwaysDark
    ...
    : mobileTransparent
    ? "absolute top-0 left-0 right-0 flex items-center justify-between px-4 py-2 bg-transparent lg:bg-card lg:border-b lg:border-border z-[75] overflow-visible"
