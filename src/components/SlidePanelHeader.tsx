...
const SlidePanelHeader = ({
  ...
  return (
    <div className="absolute top-0 left-0 right-0 lg:relative flex items-center justify-between px-4 py-2 bg-transparent lg:bg-card lg:border-b lg:border-border z-40">
