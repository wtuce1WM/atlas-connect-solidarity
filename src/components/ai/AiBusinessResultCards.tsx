              ...
              <div className="flex items-start gap-2">
                <div className="min-w-0 flex-1 flex flex-col gap-1">
                  <button
                    type="button"
                    onClick={() => onOpen(b.id, siblings)}
                    className={`text-left font-bold text-[14px] leading-tight ${light ? "text-white" : "text-[#C24B3F]"} underline decoration-dotted underline-offset-2 hover:decoration-solid break-words`}
                    style={AI_NAME_FONT}
                  >
                    {b.name}
                  </button>
