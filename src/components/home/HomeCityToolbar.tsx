...
const HomeCityToolbar = ({ city, activeBadgeId, activeLabel, breadcrumb, onCityChange, onLabelClick }: Props) => {
  ...
  return (
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <div ref={hashtagsScrollRef} className="flex items-center gap-2 overflow-x-auto cursor-grab select-none touch-pan-x [scrollbar-width:none] [&::-webkit-scrollbar]:hidden -ml-14 w-[calc(100%+3.5rem)] py-1">
        {hashtagBadges.map((b) => {
          const isActive =
            activeBadgeId === b.id ||
