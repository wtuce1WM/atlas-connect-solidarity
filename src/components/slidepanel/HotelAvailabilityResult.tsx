          ...
          <div className="flex flex-col items-center justify-start w-full">
            ...
            {fallbackPanelData.hotels.filter(h => !h.isCurrentHotel).length > 0 && (
              <button
                ...
                className="block text-center text-white bg-black/40 backdrop-blur-sm rounded-xl px-0 md:px-5 py-1.5 md:py-3 border border-white/10 mt-3 font-['Roboto',sans-serif] normal-case tracking-normal cursor-pointer hover:bg-black/50 active:bg-black/60 transition-colors w-full md:w-auto select-none"
              >
