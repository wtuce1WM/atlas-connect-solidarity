  ...
  return (
    <div className="w-full shrink-0 pointer-events-auto relative z-30">
      ...
      <div
        ...
        className={`group w-full mx-auto cursor-pointer select-none px-3 pt-2.5 pb-0.5 md:px-4 md:pt-3 md:pb-0.5 text-left ${bare ? "" : "rounded-2xl bg-gradient-to-b from-black/25 to-black/55 backdrop-blur-[2px] border border-white/10 transition-colors hover:from-black/35 hover:to-black/65"}`}
      >
        <div
