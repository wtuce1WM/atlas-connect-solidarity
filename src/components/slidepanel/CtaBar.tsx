...
export function CtaBar({
  ...
  return (
    <div
      dir="ltr"
      className={`${infoSlot ? 'shrink-0' : 'shrink-0 py-2 lg:pb-2'} flex flex-col items-center ${infoSlot ? '' : 'gap-2'} ${externalVideoInteractiveMode ? 'pointer-events-none' : 'pointer-events-auto'} ${cardsHidden && effectiveMedia?.kind === "matterport" ? 'mb-24' : ''}`}
      style={hideStyle}
    >
