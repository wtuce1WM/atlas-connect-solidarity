        ...
        {videos.map((video) => {
          ...
          return (
            ...
            >
              ...
              <p className="absolute bottom-3 left-0 right-0 px-2 py-1 text-[10px] leading-tight text-white font-medium bg-gradient-to-t from-black/80 to-transparent line-clamp-2">
                {video.title}
              </p>
            </div>
          );
