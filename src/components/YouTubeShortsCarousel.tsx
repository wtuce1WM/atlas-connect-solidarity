          ...
          return (
            <div
              ...
              className={`flex-shrink-0 rounded-xl bg-black relative cursor-pointer group/card transition-all ${
                isShort ? (size === "large" ? "w-[80px] md:w-[100px] lg:w-[140px] aspect-[9/16]" : "w-[80px] md:w-[100px] lg:w-[140px] aspect-[9/16]") : (size === "large" ? "w-[140px] md:w-[180px] lg:w-[260px] aspect-video" : "w-[200px] aspect-video")
