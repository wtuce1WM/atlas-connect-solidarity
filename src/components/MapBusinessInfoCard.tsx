...
const MapBusinessInfoCard = ({ business, onClose }: MapBusinessInfoCardProps) => {
  ...
  return (
    <div className="absolute top-0 left-0 right-0 z-10 bg-white text-black px-4 py-3 rounded-b shadow-lg sm:top-2 sm:left-2 sm:right-auto sm:min-w-[360px] sm:rounded">
