    ...
    <DialogPrimitive.Root open={open} onOpenChange={onOpenChange}>
      <DialogPrimitive.Portal>
        ...
        <DialogHeader className="p-5 pb-3 shrink-0 text-center sm:text-center">
          <DialogTitle className="text-lg font-bold text-foreground text-center" style={{ fontFamily: "'Montserrat', sans-serif" }}>
            {language === "en" ? "Choose your address" : language === "ar" ? "اختر عنوانك" : "Choisir votre adresse"}
          </DialogTitle>
          {detectedCity && isEnabled && (
            <p className="text-xs text-muted-foreground mt-0.5 text-center" style={{ fontFamily: "'Montserrat', sans-serif" }}>📍 {detectedCity}</p>
          )}
        </DialogHeader>
