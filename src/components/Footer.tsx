        ...
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div className="md:col-span-2 text-center md:text-left flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-wrap gap-4 items-center justify-center md:justify-start">
              {/* WhatsApp */}
              <a href="https://wa.me/212661439221" target="_blank" rel="noopener noreferrer" className={`${textTertiary} transition-colors hover:text-[#25D366]`} title="WhatsApp">
              ...
              {/* TikTok */}
              <a href="#" target="_blank" rel="noopener noreferrer" className={`${textTertiary} transition-colors hover:text-foreground`} title="TikTok">
              ...
              {/* Instagram */}
              <a href="#" target="_blank" rel="noopener noreferrer" className={`${textTertiary} transition-colors hover:text-[#E4405F]`} title="Instagram">
              ...
              {/* Facebook */}
              <a href="#" target="_blank" rel="noopener noreferrer" className={`${textTertiary} transition-colors hover:text-[#1877F2]`} title="Facebook">
                <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              {/* Twitter/X */}
              <a href="#" target="_blank" rel="noopener noreferrer" className={`${textTertiary} transition-colors hover:text-foreground`} title="X (Twitter)">
                <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              {/* Pinterest */}
              <a href="#" target="_blank" rel="noopener noreferrer" className={`${textTertiary} transition-colors hover:text-[#E60023]`} title="Pinterest">
              ...
              {/* SoundCloud */}
              <a href="#" target="_blank" rel="noopener noreferrer" className={`${textTertiary} transition-colors hover:text-[#FF5500]`} title="SoundCloud">
              ...
              {/* YouTube */}
              <a href="#" target="_blank" rel="noopener noreferrer" className={`${textTertiary} transition-colors hover:text-[#FF0000]`} title="YouTube">
