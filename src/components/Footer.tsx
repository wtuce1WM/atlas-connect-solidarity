        ...
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className={`space-y-2 ${textSecondary}`}>
              ...
              <li><Link to="/devenir-affilie" className="transition-colors hover:text-gold">{language === "ar" ? "أدرج شركتك" : language === "en" ? "List your business" : "<li><Link to="/devenir-affilie" className="transition-colors hover:text-gold">{language === "ar" ? "أدرج شركتك" : language === "en" ? "Add your business" : "Ajoutez votre entreprise"}</Link></li>"}</Link></li>
            </ul>
          </div>
