...
export default function AppStoreCard({ links, animationDelay = "0ms" }: AppStoreCardProps) {
  ...
  return (
    <div
      className="snap-start shrink-0 w-[20rem] md:w-[30rem] h-[15em] md:h-[20em] mb-4 relative animate-slide-in-left opacity-0"
      style={{ animationFillMode: "forwards", animationDelay }}
    >
      <div className="h-full rounded-2xl bg-black/40 backdrop-blur-sm p-4 text-white border border-white/10 flex flex-col items-center justify-center gap-6">
        <h3
