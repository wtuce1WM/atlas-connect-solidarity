...
const MenuUrlCard = ({ menus, language, animationDelay = "0ms", tallHeight, categoryIcon, onOpenUrl }: MenuUrlCardProps) => {
  ...
  return (
    <div
      className={`snap-start shrink-0 w-fit ${tallHeight ? 'h-[21.6em] md:h-[28.8em]' : 'max-h-[12.6em]'} mb-4 rounded-2xl bg-black/40 backdrop-blur-sm border border-white/10 p-4 text-white overflow-y-auto overscroll-contain animate-slide-in-left opacity-0`}
