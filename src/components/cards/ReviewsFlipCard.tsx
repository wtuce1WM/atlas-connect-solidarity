...
const ReviewsFlipCard = ({
  ...
  return (
    <div
      className={`snap-start shrink-0 w-[20rem] h-[18em] md:h-[25.7em] mb-4 rounded-2xl bg-black/40 backdrop-blur-sm border border-white/10 animate-slide-in-left opacity-0 ${className}`}
