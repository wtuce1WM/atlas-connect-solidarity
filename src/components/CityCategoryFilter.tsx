...
const CityCategoryFilter = ({
  ...
  return (
    <>
      ...
      <div data-category-filter className={`sticky z-[4] bg-background/95 backdrop-blur-sm border-b border-border py-3`} style={{ top: `${baseTop}px` }}>
      ...
      {selectedCategory && !isLoadingSubs && subcategories.length > 0 && (
        <div className={`sticky z-[3] bg-background/90 backdrop-blur-sm border-b border-border/50 py-2`} style={{ top: `${baseTop + 62}px` }}>
          <div className="mx-auto px-4 max-w-[80%]">
            <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
      ...
      {selectedSubcategory && !isLoadingServices && services.length > 0 && (
        <div className={`sticky z-[2] bg-background/85 backdrop-blur-sm border-b border-border/30 py-2`} style={{ top: `${baseTop + 114}px` }}>
          <div className="mx-auto px-4 max-w-[80%]">
            <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
              {services.map((svc) => {
