      ...
      <div
        ...
        className={`mb-6 transition-all duration-500 ease-out ${
          isPanelExpanded
            ...
            : isPanelOpen
              ? "fixed top-[50px] left-0 z-[100] w-1/2 h-[calc(100%-50px)] overflow-y-auto p-6 flex items-start justify-center bg-white dark:bg-zinc-900 animate-slide-down-from-top"
              : "w-[70%] mx-auto"
        }`}
