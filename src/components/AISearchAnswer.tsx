...
const AISearchAnswer = ({ query, businesses, isSearchLoading, onAnswerReady }: AISearchAnswerProps) => {
  ...
  return (
    <>
      ...
      {isPanelOpen && (
        <div className={`fixed top-[72px] right-0 z-[100] bg-background shadow-2xl border-l border-border overflow-hidden transition-all duration-500 ease-out animate-slide-in-right flex flex-col ${isPanelExpanded ? "w-full" : "w-1/2"}`} style={{ height: "calc(100vh - 72px)" }}>
