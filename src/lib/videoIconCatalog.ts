...
export const VIDEO_ICON_CATALOG: IconCategory[] = [
  ...
  },
  {
    ...
    icons: [
      i("md:MdOutlineTerrain", "Désert / Dromadaire", "camel", "desert", "chameau", "dune"),
      ...
      i("tb:TbAirBalloon", "Montgolfière", "balloon", "vol", "air"),
      i("md:MdOutlineSurfing", "Surf", "surfing", "essaouira", "vague"),
  ...
  },
  {
    ...
    icons: [
      ...
      i("tb:TbTrees", "Palmeraie", "palm", "palmier", "oasis"),
  ...
  },
  {
    ...
    icons: [
      ...
      i("tb:TbLeaf2", "Aromathérapie", "huile", "aroma", "argan"),
  ...
  },
  {
    ...
    icons: [
      ...
      i("tb:TbTexture", "Tapis", "tapis", "carpet", "berbere"),
  ...
  },
  {
    ...
    icons: [
      ...
      i("md:MdOutlineNightlife", "Club", "club", "boite", "nightclub"),
  ...
  },
  {
    ...
    icons: [
      ...
      i("fa6:FaHandHoldingHeart", "Local / Solidaire", "local", "terroir", "solidaire"),
    ],
  },
  {
    id: "brands",
