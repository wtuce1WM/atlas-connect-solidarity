...
const CSS = `
  ...
  .join-page .way.green{background:#dfeee5}
  .join-page .way.orange{background:#fde4d3}
  .join-page .way .badge{width:54px;height:54px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-family:'Josefin Sans',sans-serif;font-weight:700;font-size:24px;color:#fff;margin-bottom:22px}
  .join-page .way.green .badge{background:#3e8e7e}
  .join-page .way.orange .badge{background:var(--orange)}
  ...
  .join-page .way.green .way-cta{background:#3e8e7e}
  ...
  .join-page .way.green .tag{color:#2d6b5f}
