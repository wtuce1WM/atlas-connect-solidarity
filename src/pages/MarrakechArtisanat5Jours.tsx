...
// 5 jours organisés par quartier — 31 adresses au total
...
const MarrakechArtisanat5Jours = () => {
  ...
  useSEO({
    ...
    description:
      "Itinéraire de 5 jours à Marrakech : 31 adresses sélectionnées (Guéliz, Médina, Sidi Ghanem) pour découvrir le meilleur de l'artisanat marocain.",
        ...
        <div className="absolute inset-0 flex flex-col justify-end pb-12">
          <div className="container mx-auto px-4">
            ...
            <p className="mt-4 text-white/70 max-w-2xl text-lg">
              Un itinéraire en 5 étapes — 31 adresses sélectionnées à Guéliz,
