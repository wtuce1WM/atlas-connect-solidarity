          ...
          {isLoading ? null : filteredBusinesses.length === 0 ? (
            ...
            <>
              ...
              {resolvedHotelSearchInfo && (
                <div className="sticky z-[20] mb-4 rounded-md border border-primary/40 bg-primary/10 px-3 py-2 shadow-sm backdrop-blur-sm" style={{ top: '53px' }}>
              ...
              {/* Results grid */}
              <div className={`grid gap-4 ${resolvedHotelSearchInfo ? "pt-4" : "pt-10 sm:pt-4 md:pt-4 lg:pt-14"} pb-6 [overflow-anchor:none] ${compactPanelBusiness ? "grid-cols-1 sm:grid-cols-2" : (hasKnownLocation && !hideResultsMap) ? "grid-cols-1 lg:grid-cols-2" : "grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"}`}>
