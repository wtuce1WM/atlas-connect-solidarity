        ...
        <div className={hasKnownLocation && !compactPanelBusiness && !hideResultsMap ? "flex gap-0" : ""}>
          ...
          {isLoading ? null : filteredBusinesses.length === 0 ? (
            ...
            <>
              ...
              <div ref={resultsBarRef} data-results-bar className={`sticky z-[19] bg-white lg:bg-white flex items-center justify-center px-4 gap-2 relative py-4 sm:py-2 md:py-2 lg:py-1.5 lg:hidden ${resolvedHotelSearchInfo ? 'top-[101px] md:top-[91px]' : 'top-[53px]'}`}>
                {isSubDesktop && (
                  <button
