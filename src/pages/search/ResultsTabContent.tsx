  ...
  return (
    ...
    >
        ...
        {showFiltersOverlay && (() => {
          ...
          return (
            <div
              className={`fixed inset-0 z-[90] shadow-2xl flex flex-col bg-no-repeat bg-cover bg-center animate-slide-up-from-bottom ${compactPanelBusiness ? "lg:left-1/2" : "lg:left-1/2"}`}
