        ...
        {homeState && (
          <div className={heroLayout ? "flex h-full w-full flex-col items-center overflow-hidden" : "flex flex-col items-center justify-center gap-5 md:gap-6 px-1 py-4 md:py-8 w-full"}>
            ...
            <div className="w-full max-w-xl md:max-w-4xl mx-auto flex flex-col items-center gap-2">
              <div ref={badgesRowRef} data-badges-row className={`w-full flex ${showSuggestionsWrap ? "flex-wrap" : "flex-nowrap md:flex-wrap"} items-stretch justify-start md:justify-center gap-2 overflow-x-auto scrollbar-hide pb-1`}>
