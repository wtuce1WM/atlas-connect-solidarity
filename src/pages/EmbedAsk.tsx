...
const EmbedAsk = ({ paramsOverride }: { paramsOverride?: string } = {}) => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={scrollRef}
        className={`${autoHeight ? "flex-none" : "flex-1 overflow-y-auto scrollbar-hide"} px-4 ${heroLayout && !homeState ? "pt-16 md:pt-20" : heroLayout && homeState ? "pt-10 md:pt-4" : "pt-4"} pb-8 space-y-3 ${bg} relative`}
