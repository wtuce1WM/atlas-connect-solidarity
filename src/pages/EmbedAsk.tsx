      ...
      <div ref={scrollRef} className={`${autoHeight ? "flex-none" : "flex-1 overflow-y-auto scrollbar-hide"} px-4 pt-4 pb-8 space-y-3 ${bg} relative`}>
        ...
        {homeState && (
          <div className={heroLayout ? "flex h-full w-full flex-col items-center overflow-hidden" : "flex flex-col items-center justify-center gap-5 md:gap-6 px-1 py-4 md:py-8 w-full"}>
            ...
            <div ref={badgesRefRow} data-badges-row className="w-full max-w-xl mx-auto flex flex-nowrap md:flex-wrap items-stretch md:items-center justify-start md:justify-center gap-2 overflow-x-auto md:overflow-visible scrollbar-hide pb-1">
