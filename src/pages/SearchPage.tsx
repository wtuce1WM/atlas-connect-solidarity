...
import { Loader2, Building2, ChevronLeft, ChevronRight, Search, Mic, Loader, MapPin, MapPinOff, X, Volume2, VolumeX, Clock, Map, Sparkles, SlidersHorizontal, ChevronDown, ChevronUp, RefreshCw, Compass, Maximize2, Minimize2, Star } from "lucide-react";
        ...
        return (
          <div className="flex">
            ...
            {poiSelectedBusinessId && (
              <div className={`fixed top-0 left-0 right-0 bottom-0 z-40 bg-background shadow-2xl overflow-hidden flex flex-col animate-slide-in-right lg:top-[53px] lg:left-auto lg:bottom-auto lg:border-l lg:border-border ${poiPanelExpanded ? "lg:w-full border-l-2 border-border shadow-[-8px_0_30px_-5px_rgba(0,0,0,0.15)]" : "lg:w-1/2"}`} style={{ height: isSubDesktop ? undefined : "calc(100vh - 53px)" }}>
                <SlidePanelHeader
        ...
        return (
          <div className="flex">
            ...
            {destSelectedBusinessId && (
              <div className={`fixed top-0 left-0 right-0 z-40 bg-background shadow-2xl overflow-hidden flex flex-col animate-slide-in-right lg:top-[54px] lg:left-auto lg:border-l lg:border-border ${destPanelExpanded ? "lg:w-full" : "lg:w-1/2"}`} style={{ height: isSubDesktop ? "100vh" : "calc(100vh - 54px)" }}>
                <SlidePanelHeader
        ...
        >
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div ref={resultsBarRef} data-results-bar className="sticky z-[19] bg-background flex items-center justify-between py-2 mb-2 border-b border-border/40" style={{ top: `${Math.max(stickyStackPadding || 0, 104)}px` }}>
                <div className="flex items-center gap-3">
              ...
              <div className={`grid gap-4 pt-4 sm:pt-4 ${compactPanelBusiness ? "grid-cols-1 sm:grid-cols-2" : hasKnownLocation ? "grid-cols-1 lg:grid-cols-2" : "grid-cols-1 sm:grid-cols-3 lg:grid-cols-4"}`}>
