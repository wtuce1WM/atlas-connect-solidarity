      ...
      {activeTab === "poi" && (() => {
        ...
        return (
          <div className={`flex ${(poiSelectedBusinessId || poiMapBusiness) ? "" : ""}`}>
            ...
            {poiMapBusiness && (
              <div className={`fixed top-0 left-0 right-0 z-[100] bg-background shadow-2xl overflow-hidden flex flex-col lg:animate-slide-up-from-bottom animate-slide-in-left lg:w-1/2 lg:top-[54px] lg:left-auto lg:border-l lg:border-border`} style={{ height: isMobile ? "100vh" : "calc(100vh - 54px)" }}>
                <div className="shrink-0 flex items-center px-4 py-2 bg-white border-b border-border z-40">
                  <div className="flex items-center gap-3 shrink-0">
                    <button
