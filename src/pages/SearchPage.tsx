        ...
        >
          ...
          {isLoading ? null : filteredBusinesses.length === 0 && !showZitounEasterEgg && !showCelebrityGuide && !showSosMedecin && !showPompiers ? (
            ...
            <>
               ...
               <div ref={resultsBarRef} data-results-bar className="sticky z-[19] bg-green-500 lg:bg-white flex items-center justify-center px-4 gap-2 relative py-3 sm:py-3 lg:py-1.5 lg:hidden" style={{ top: '53px' }}>
                {isSubDesktop && (
                  <button
                    onClick={() => setShowMobileMap(true)}
