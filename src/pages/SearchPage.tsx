        ...
        >
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className={`grid gap-4 pt-8 sm:pt-8 pb-28 ${compactPanelBusiness ? "grid-cols-1 sm:grid-cols-2" : hasKnownLocation ? "grid-cols-1 lg:grid-cols-2" : "grid-cols-1 sm:grid-cols-3 lg:grid-cols-4"}`}>
