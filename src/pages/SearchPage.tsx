  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      */}
      ...
      {activeTab === "map" && (
        <section className="pt-4 pb-4 lg:py-12 bg-background">
      ...
      {activeTab === "poi" && (() => {
        ...
        return (
          <div className={`flex ${(poiSelectedBusinessId || poiMapBusiness) ? "" : ""}`}>
            ...
            {poiMapBusiness && (
              <div className={`fixed top-0 left-0 right-0 z-[100] bg-background shadow-2xl overflow-hidden flex flex-col animate-slide-in-right lg:w-1/2 lg:top-[62px] lg:left-auto lg:border-l lg:border-border`} style={{ height: isMobile ? "100vh" : "calc(100vh - 62px)" }}>
                <div className="shrink-0 flex items-center px-4 py-2 bg-background border-b border-border z-40">
                  <div className="flex items-center gap-3 shrink-0">
                    <button
