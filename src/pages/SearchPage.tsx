        ...
        >
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className={`grid gap-4 pt-10 md:pt-8 lg:pt-8 pb-28 [overflow-anchor:none] ${compactPanelBusiness ? "grid-cols-1 sm:grid-cols-2" : hasKnownLocation ? "grid-cols-1 lg:grid-cols-2" : "grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"}`}>
