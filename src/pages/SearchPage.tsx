      ...
      {showAiPopup && !compactPanelBusiness && (
        <div className="fixed inset-0 z-[200] flex bg-background/95 backdrop-blur-sm animate-in fade-in duration-200">
          ...
          {overlaySelectedBusiness && (
            <div className={`h-full flex flex-col bg-background animate-in slide-in-from-right duration-300 transition-all ${<div className={`h-full flex flex-col bg-background animate-in slide-in-from-right duration-300 transition-all ${isOverlayPanelExpanded ? "w-[80%]" : "w-1/2"}`}>}`}>
              <SlidePanelHeader
        ...
        <>
          ...
          >
            ...
            <div className="flex-1 min-h-0 overflow-y-auto px-6 py-5">
              ...
              <div className="flex items-center justify-center gap-20 pt-8">
                {/* Listen */}
                <div className="relative flex items-center justify-center">
