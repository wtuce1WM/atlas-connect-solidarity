        ...
        <>
          ...
          >
            <SlidePanelHeader
              ...
              onToggleExpand={isCompactPanelWebOnly ? undefined : (isCompactPanelBookOnline ? (isCompactPanelExpanded ? () => setIsCompactPanelExpanded(false) : undefined) : (compactBusinessImageCount > 5 ? () => setIsCompactPanelExpanded(prev => !prev) : undefined))}
            />
