        ...
        >
          ...
          {isLoading ? (
            ...
            <>
                ...
                <div className="flex items-center gap-3">
                  {displayedResultsCount > 0 && (
                    <span className="text-xs text-muted-foreground font-medium">
                      {displayedResultsCount} {language === "en" ? "result" : language === "ar" ? "نتيجة" : "résultat"}{displayedResultsCount > 1 && language !== "ar" ? "s" : ""}
                    </span>
                  )}
                </div>
                <div className="flex items-center gap-2">
              ...
              <div className={`grid gap-4 pt-8 sm:pt-8 ${compactPanelBusiness ? "grid-cols-1 sm:grid-cols-2" : hasKnownLocation ? "grid-cols-1 lg:grid-cols-2" : "grid-cols-1 sm:grid-cols-3 lg:grid-cols-4"}`}>
