...
const SearchPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ overflowX: 'clip' }}>
      ...
      {/* Floating Search Bar */}
      <div className={`fixed bottom-0 bg-white border-t border-border pt-3 py-3 px-4 md:px-4 transition-transform duration-300 ${hasKnownLocation && !compactPanelBusiness ? "left-0 w-1/2" : "left-0 right-0"} ${((isCompactPanelWebOnly || isCompactPanelBookOnline) && compactPanelBusiness) || (isSubDesktop && showMobileMap) ? "translate-y-full" : ""} ${isCompactPanelExpanded ? "z-[190]" : "z-[210]"}`}>
