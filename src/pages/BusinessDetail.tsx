      ...
      <main className="container mx-auto px-4 py-24">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="space-y-6">
            ...
            {/* Social Media */}
            {(business.facebook_url || business.instagram_url || business.linkedin_url || business.youtube_url || business.tiktok_url || business.whatsapp || business.twitter_url || business.pinterest_url || business.skype || business.vimeo_url) && (
              <Card>
                <CardContent className="p-6">
