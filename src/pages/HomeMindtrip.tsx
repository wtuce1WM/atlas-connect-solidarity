                            ...
                            {/* Mobile/Tablet/Desktop Content Layout with absolute full-size mockup */}
                             <div className="relative w-full mt-6 md:mt-8 flex-1 min-h-[180px]">
                              ...
                              <img
                                ...
                                alt=""
                                aria-hidden="true"
                                className="step9-float pointer-events-none select-none absolute top-[15%] sm:top-auto sm:bottom-[-16px] md:bottom-[45px] lg:bottom-[-16px] right-[-10%] sm:right-[-5%] h-[75%] sm:h-[55%] md:h-[82%] lg:h-[65%] w-auto object-contain object-bottom z-0 drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)]"
                              />
                            </div>
                          </div>
                        ) : (
