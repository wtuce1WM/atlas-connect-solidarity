  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div>
        ...
        <picture>
          <source media="(max-width: 767px)" srcSet={heroImageMobile} />
           <img
              ...
              className="absolute top-[10%] left-0 right-0 h-[85%] md:inset-0 md:h-[120%] w-full origin-top object-contain object-bottom md:object-cover md:object-[70%_top] lg:object-right-top will-change-transform"
              loading="eager"
              fetchPriority="high"
            />
        </picture>
        ...
        <div className="home-hero-content relative z-20 mx-auto flex min-h-[92vh] max-w-7xl flex-col items-center justify-end pb-28 text-center px-6 pt-48 md:justify-center md:py-24 md:px-12">
        ...
        {/* Mobile-only video CTA placed absolutely at the bottom of the section */}
        <div className="md:hidden absolute bottom-4 left-1/2 -translate-x-1/2 z-30 flex justify-center">
          <button
            type="button"
            onClick={() => setVideoOpen(true)}
            className="inline-flex items-center gap-3 text-[#F1F1F1] hover:opacity-80 transition-opacity home-hero-video-cta"
        ...
        <button
          ...
          className="hidden md:block absolute bottom-8 left-1/2 z-30 -translate-x-1/2 text-white/70 transition hover:text-white"
        >
                 ...
                 >
                  ...
                  {(i === 1 || i === 2 || i === 3 || i === 4 || i === 6) ? (
                    ...
                    <>
                      ...
                      <div className={`relative z-10 ${i === 7 ? "text-left md:text-center flex flex-col items-start md:items-center justify-between h-full min-h-[300px] md:min-h-[400px] flex-1" : ""}`}>
                        {i === 7 && (
...
const HotelAvailabilityWidget = () => {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="rounded-full bg-primary hover:bg-primary/90 border border-white/30 px-5 py-2.5 font-josefin text-xs tracking-[0.2em] text-primary-foreground shadow-[0_8px_32px_rgba(0,0,0,0.25),inset_0_1px_0_rgba(255,255,255,0.35)] transition sm:col-span-2 md:px-6 md:py-3 md:text-sm"
      >
