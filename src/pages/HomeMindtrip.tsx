  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-8 md:pt-10">
        ...
        <div className="relative z-20 mx-auto flex min-h-[92vh] max-w-7xl flex-col justify-center md:justify-start lg:justify-center px-6 py-24 md:pt-14 lg:pt-24 md:px-12">
