  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-8 md:pt-10">
        ...
        <div className="relative z-20 mx-auto flex min-h-[92vh] max-w-7xl translate-y-10 flex-col justify-start px-6 pt-72 pb-6 md:translate-y-0 md:justify-start md:py-24 md:pt-14 md:px-12 lg:justify-center lg:pt-24">
