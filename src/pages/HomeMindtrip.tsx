      ...
      <div>
        ...
        <picture>
          ...
          <img
             ...
             className="absolute inset-0 h-[90%] md:h-[120%] w-full origin-top object-cover object-center md:object-[70%_top] lg:object-right-top translate-y-[4%] md:translate-y-0 will-change-transform"
             loading="eager"
             fetchPriority="high"
           />
        </picture>
