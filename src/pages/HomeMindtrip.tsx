      ...
      <div>
        ...
        <picture>
          ...
          <img
             ...
             className="absolute top-[10%] left-0 right-0 h-[90%] md:inset-0 md:h-[120%] w-full origin-top object-cover object-center md:object-[70%_top] lg:object-right-top will-change-transform"
             loading="eager"
             fetchPriority="high"
           />
        </picture>
