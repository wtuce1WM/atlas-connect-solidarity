...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  #presentation {
    ...
    inset: 0;
    opacity: 0;
    animation: showPresentation 0.5s ease 4.5s forwards;
  }
  ...
  #progress {
    ...
    left: 0;
    height: 2px;
    background: linear-gradient(to right, var(--deep-red), var(--gold));
    z-index: 60;
  ...
  .grid-img:hover { filter: brightness(0.5) saturate(1.3); }
  @keyframes shimmer {
  ...
  #autoplay-bar {
    ...
    background: rgba(201,168,76,0.3);
    z-index: 60;
    animation: autoplayProgress 6s linear infinite;
  }
...
<div id="intro">
  ...
  <div class="intro-sub">عالم واحد المغرب</div>
  <div class="intro-tagline">The World from a Different Angle</div>
</div>
...
<div id="presentation">
  ...
  <div class="slide active" data-slide="0">
    ...
    <div class="slide-content">
      <div class="slide-label">Welcome · مرحباً · Bienvenue</div>
      <h1 class="slide-title">ONE WORLD<br><span>MOROCCO</span></h1>
      <div class="slide-divider"></div>
      <p class="slide-quote">"Where the Atlantic meets the Sahara, where ancient meets eternal — Morocco reveals the world from a different angle."</p>
    </div>
  </div>
  ...
  <div class="slide" data-slide="1">
    ...
    <div class="slide-content">
      <div class="slide-label">Luxury · الفخامة</div>
      <h2 class="slide-title"><span>BE THE COOLEST</span></h2>
      <div class="slide-divider"></div>
      <p class="slide-quote">Rooftop terraces overlooking medinas, sunsets over the Atlantic — where comfort meets the soul of Morocco.</p>
    </div>
  </div>
  ...
  <div class="slide" data-slide="2">
    ...
    <div class="slide-content">
      ...
      <h2 class="slide-title"><span>ROOTS & SOUL</span></h2>
      <div class="slide-divider"></div>
      <p class="slide-quote">A tapestry woven from Amazigh, Arab, African, and Andalusian threads — Morocco's culture is the world in one land.</p>
    </div>
  </div>
  ...
  <div class="slide" data-slide="3">
    ...
    <div class="slide-content">
      <div class="slide-label">Adventure · المغامرة</div>
      <h2 class="slide-title"><span>DESERT DREAMS</span></h2>
      <div class="slide-divider"></div>
      <p class="slide-quote">Lantern-lit camps under a billion stars. The call of the Sahara. Jemaa el-Fna alive with ancient stories at dusk.</p>
    </div>
  </div>
  ...
  <div class="slide" data-slide="4">
    ...
    <div class="slide-content">
      ...
      <h2 class="slide-title"><span>TIMELESS RITUALS</span></h2>
      <div class="slide-divider"></div>
      <p class="slide-quote">Mint tea poured with ceremony. The Koutoubia minaret kissed by sunset. Every gesture, an act of hospitality.</p>
    </div>
  </div>
  ...
  <div class="slide" data-slide="5">
    ...
    <div class="slide-content">
      <div class="slide-label">Connection · الوصل</div>
      <h2 class="slide-title"><span>SHARED JOURNEYS</span></h2>
      <div class="slide-divider"></div>
      <p class="slide-quote">Where travelers become family. Dunes at sunset with new friends. Tanneries of Fes. The architecture of a thousand years.</p>
    </div>
  </div>
  ...
  <div class="slide" data-slide="6">
    ...
    <div class="slide-content">
      ...
      <h2 class="slide-title">KEEP YOUR COINS —<br><span>WANT CHANGE</span></h2>
      <div class="slide-divider"></div>
      <p class="slide-quote">Morocco doesn't just show you something new. It changes you. A riad courtyard under moonlight. Spices of a thousand years.</p>
    </div>
  </div>
  ...
  <div class="slide" data-slide="7">
    ...
    <div class="slide-content">
      ...
      <h2 class="slide-title"><span>UNDER THE BLOOD MOON</span></h2>
      <div class="slide-divider"></div>
      <p class="slide-quote">The Hamsa watches over blue fishing boats. Ancient protection. Timeless beauty. Morocco speaks in symbols.</p>
    </div>
  </div>
  ...
  <div class="slide" data-slide="8">
    ...
    <div class="slide-content">
      ...
      <div class="slide-divider"></div>
      <p class="slide-quote">From Times Square to the medina. From Gothic cathedrals to Moroccan arches. All faiths, all cultures — one world, one home.</p>
    </div>
  </div>
  ...
  <div class="slide" data-slide="9">
    ...
    <div class="slide-content">
      <div class="slide-label">One World Morocco · عالم واحد المغرب</div>
      <h2 class="slide-title">THE WORLD FROM<br><span>A DIFFERENT ANGLE</span></h2>
      <div class="slide-divider"></div>
      <p class="slide-quote">Experience Morocco as it truly is — through its people, its land, its spirit. Join us. The journey begins here.</p>
...
<script>
  ...
  function changeSlide(dir) {
    goToSlide((current + dir + total) % total);
  }
...
const BlogPresentation = () => {
  ...
  useEffect(() => {
    if (iframeRef.current) {
      ...
      if (doc) {
        doc.open();
        doc.write(`<!DOCTYPE html><html><head><meta charset="UTF-8"></head><body>${PRESENTATION_HTML}</body></html>`);
        doc.close();
      }
    }
  }, []);
    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="w-full" style={{ height: "100vh" }}>
        <iframe
          ...
          title="One World Morocco Presentation"
