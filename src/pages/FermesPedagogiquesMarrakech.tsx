...
const FermesPedagogiquesMarrakech = () => (
  <BlogArticleTemplate
    ...
    articleDescription="Huit adresses à quelques minutes de la ville ocre, pour offrir aux enfants — et aux parents — une vraie journée de nature, entre animaux, ateliers et plantes aromatiques."
    ...
    heroSubtitle="Huit adresses à quelques minutes de la ville ocre, pour offrir aux enfants — et aux parents — une vraie journée de nature, entre animaux, ateliers et plantes aromatiques."
    intro="Marrakech a beau être une ville d'effervescence, ses environs immédiats cachent quelques refuges de verdure où l'on respire autrement. Pour les familles, ces fermes pédagogiques sont une respiration nécessaire : un terrain de jeu grandeur nature où les enfants courent après les poules, donnent à manger aux ânes, plongent les mains dans la terre et apprennent — sans s'en rendre compte — d'où viennent les choses. Voici nos huit adresses préférées, toutes accessibles en moins d'une heure depuis la médina."
