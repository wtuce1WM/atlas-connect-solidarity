  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* CTA vert « Découvrez l'App » retiré : le feed vidéo s'ouvre
            automatiquement au chargement de la homepage. */}
      ...
      {demoActiveId && (() => {
        ...
        return (
          <Suspense fallback={null}>
            <HomeVideoSlidePanel
              open
              onClose={() => { setDemoActiveId(null); setDemoCardsOnly(false); setDemoIntro(false); }}
