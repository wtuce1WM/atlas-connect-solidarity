...
const CSS = `
  ...
  .card-page .url-label::after{content:"";position:absolute;right:30%;bottom:-46px;width:165px;height:48px;border-right:2px dashed var(--terracotta);border-bottom:2px dashed var(--terracotta);border-bottom-right-radius:30px}
