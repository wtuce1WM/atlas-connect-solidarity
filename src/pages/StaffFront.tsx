    ...
    <div className="min-h-screen bg-muted">
      ...
      {showTopArrow && (
        <button
          ...
          className="fixed top-24 left-1/2 -translate-x-1/2 z-[55] p-2.5 rounded-full bg-primary text-primary-foreground shadow-lg hover:bg-primary/90 transition-all"
      ...
      {showBottomArrow && (
        <button
          ...
          className="fixed bottom-24 left-1/2 -translate-x-1/2 z-[55] p-2.5 rounded-full bg-primary text-primary-foreground shadow-lg hover:bg-primary/90 transition-all"
