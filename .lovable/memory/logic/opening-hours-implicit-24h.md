...
- **Vacances / Fermetures exceptionnelles (`vacation_dates`) priment sur tout** : si la date cible tombe dans une plage, le business est exclu même s'il est `is_open_24h` ou sans horaires publiés.
